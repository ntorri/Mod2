...
public class ModItems {
	...
	public static void createItems() {
		...
		chocolate.setCreativeTab(Main.tabCreeper);
		...
		luckyCandy.setCreativeTab(Main.tabCreeper);
	}
}
